...
layout =  html.Div([ 
    ...
    dbc.Container([
        ...
        dbc.Row(
            [
                dbc.Col(content1, md=4),
                dbc.Col(content2, md=4),
                dbc.Col(content3, md=4),
            ]
        ),
    # Dropdown #1
    ...
    # Dropdown #3
    html.Label("Topic:", style={'fontSize':20, 'textAlign':'center'}),
    dcc.Dropdown(
        id='topic-filter',
        options=[],
        value=None  # Initially show all dates
    ...
    dcc.Graph(id='display-map1', figure={}),
    ...
    className='dropdown-container',  # Class for container positioning
    )
